...
namespace Alpha.Collector.Core
{
    ...
    /// 快彩在线采集体彩排列3
    /// </summary>
    public class KCTCPL3Picker : BasePicker, IPicker, ITCPL3Picker
    {
        private KCPicker _kcPicker;

        public KCTCPL3Picker()
        {
            this._kcPicker = new KCPicker(LotteryEnum.TCPL3);
        }
        ...
        public bool IsValid
        {
            get
            {
                return base.LotteryList.Contains(LotteryEnum.TCPL3) && base.DataSourceList.Contains(DataSourceEnum.KC);
            }
        }
    }
}
