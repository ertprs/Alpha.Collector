...
namespace Alpha.Collector.Utils
{
    ...
    public class CacheManager
    {
        ...
        static CacheManager()
        {
            ...
            //cache = (ICache)Activator.CreateInstance(typeof(DictionaryCache));
            //cache = (ICache)Activator.CreateInstance(typeof(FileCache));
        }
        ...
        /// <returns></returns>
        public static T GetOrSet<T>(string key, Func<T> acquire, long cacheTime = 600)
        {
        ...
        public static void Add(string key, object value, long expiratTime = 600)
        {
