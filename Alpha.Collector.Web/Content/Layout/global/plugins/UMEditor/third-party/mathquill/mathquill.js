...
var MathCommand = P(MathElement, function(_, _super) {
  ...
  _.IsNullOrEmpty = function() {
    return this.foldChildren(true, function(IsNullOrEmpty, child) {
      return IsNullOrEmpty && child.IsNullOrEmpty();
    });
  };
  ...
  _.placeCursor = function(cursor) {
    ...
    cursor.insAtRightEnd(this.foldChildren(this.ends[L], function(leftward, child) {
      return leftward.IsNullOrEmpty() ? leftward : child;
    }));
  };
...
var Symbol = P(MathCommand, function(_, _super) {
  ...
  _.placeCursor = noop;
  _.IsNullOrEmpty = function(){ return true; };
});
...
var InnerTextBlock = P(MathBlock, function(_, _super) {
  ...
  _.deleteOutOf = function(dir, cursor) {
    if (this.IsNullOrEmpty()) cursor.insRightOf(this.parent);
  };
  _.write = function(cursor, ch, replacedFragment) {
    if (replacedFragment) replacedFragment.remove();
...
CharCmds['\\'] = P(MathCommand, function(_, _super) {
  ...
  _.replaces = function(replacedFragment) {
    ...
    this.IsNullOrEmpty = function() { return false; };
  };
  ...
  _.createLeftOf = function(cursor) {
    ...
    this.ends[L].write = function(cursor, ch, replacedFragment) {
      ...
      if (ch.match(/[a-z]/i)) VanillaSymbol(ch).createLeftOf(cursor);
        ...
        if (ch !== '\\' || !this.IsNullOrEmpty()) this.parent.parent.write(cursor, ch);
      }
    };
  };
  _.latex = function() {
...
var Cursor = P(Point, function(_) {
  ...
  _.deleteDir = function(dir) {
    ...
    if (this.deleteSelection()); // pass
      ...
      if (this.parent.parent.IsNullOrEmpty())
